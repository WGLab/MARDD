...
- **Visualize disease-specific facial patterns** learned by StyleGAN3 from GMDB
- **Compare synthetic exemplars** across different demographic groups
- **Support qualitative evaluation** of the generator's ability to capture disease phenotypes
- **Provide teaching materials** for clinical geneticists without patient privacy concerns
